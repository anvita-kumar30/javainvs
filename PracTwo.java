...
class Form implements ActionListener {
    ...
    Form() {
        JFrame frame = new JFrame("Library Membership Form");
        ...
        JLabel l0 = new JLabel("Which type of books");
        l0.setBounds(50, 250, 120, 30);
        frame.add(l0);
        JCheckBox c1 = new JCheckBox("Business/Economics");
        c1.setBounds(200, 250, 150, 50);
        JCheckBox c2 = new JCheckBox("Philosophy");
        c2.setBounds(200, 300, 150, 50);
        JCheckBox c3 = new JCheckBox("Crafts/Hobbies");
